                    ...
                    <button
                        onClick={async () => {
                            ...
                            try {
                                ...
                                setError(err.message || 'Gick inte att logga in med Google');
                                setLoading(false);
                            }
                        }}
                        disabled={loading}
                        className="w-full px-6 py-4 bg-white text-slate-900 rounded-xl font-bold uppercase tracking-wider hover:bg-slate-100 transition-colors disabled:opacity-50 flex items-center justify-center gap-3"
                    >
