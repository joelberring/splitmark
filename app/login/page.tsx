...
export default function LoginPage() {
    ...
    const handleDemoLogin = async () => {
        setLoading(true);
        try {
            // Demo login - just set a fake user in localStorage
        ...
        <div className="min-h-screen flex flex-col bg-slate-950 text-white">
            ...
            <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-12">
                ...
                <p className="text-slate-400 text-center mb-8 max-w-xs">
                    Logga in för att anmäla dig till tävlingar, se resultat och spåra din utveckling.
                </p>

                {/* Error */}
                {error && (
                    <div className="w-full max-w-sm bg-red-900/20 border border-red-700/50 rounded-xl p-4 mb-6 text-center">
                ...
                <div className="w-full max-w-sm space-y-3">
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white text-slate-900 rounded-xl font-bold uppercase tracking-wider hover:bg-slate-100 transition-colors disabled:opacity-50"
                    >
